...
ucUserThemeBG		: 3,                            // رقم سمة الخلفية المختارة (من 0 إلى 39)                                  
...
ucForcedVertical	: 0,                            // فرض وضع العرض العمودي (0 معطل، 1 مفعل)                                                     
...
//----------------------------------------------------------------------
const JS_VR_AYA_SIZE	= 60;	// no change
const JS_VR_HADITH_SIZE	= 53;   // no change

const JS_MainAzkarViewTime	= 18; // 18 seconds of viewing each main Azkar after Salat
const JS_SabahMasaaViewTime	= 25; // 25 seconds of viewing each Azkar Sabah/Masaa

const JS_SlidesViewTime		= 25; // 25 seconds of viewing each Slide (maximum 60 seconds [1min])
const JS_SLIDES_OFF_TIME	= 20; // 20 seconds between slides (maximum 300 seconds [5min])
...
const JS_BottomMessagesFontSameAsAzkar = 0; // make font of bottom messages same az Azkar font 
